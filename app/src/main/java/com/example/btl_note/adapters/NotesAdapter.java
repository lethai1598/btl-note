package com.example.btl_note.adapters;
...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteHolder>{
    ...
    public void onBindViewHolder(NoteHolder holder, int position) {
        ...
        if (note != null) {
            ...
            if (multiCheckMode){
                holder.checkBox.setVisibility(View.VISIBLE); //showw checkbox
                holder.checkBox.setChecked(note.isChecked());
            }
            else{
                holder.checkBox.setVisibility(View.GONE);// hidden checkbox off
            }
